...
public class LoginStepsDef {
    ...
    public void setUp(){
        //setUp
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\ahuamanz\\Desktop\\NTT DATA\\Automatizacion web\\qa-lab-selenium\\drivers\\chromedriver.exe");
        //crear el driver
    ...
    public void queMeEncuentroEnLaPáginaDePractica() {
        driver.get("http://automationpractice.com/index.php");
        screenShot();
    }

    @Cuando("hago clic en el boton sign")
    public void hagoClicEnElBotonSign() {
        LoginSteps loginSteps = new LoginSteps(driver);
        loginSteps.singn();
    }
}
